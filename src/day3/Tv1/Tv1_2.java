...
/*
객체 생성과 객체 배열에 있는 예제 클래스를 따로따로 만들어도 진행이 되는데 같이 만들어야 하는 이유가 있나요?
같이 만들면 두 개로 나눠져서 따로 따로 만들지 않는 이유가 있나 궁금합니다..ㅎㅎ
하나의 묶음으로 만들어 코드의 가독성 및 효율을 높여주기 때문인가요??

하나의 클래스 안에 여러 클래스를 만드는 이유는 효율을 높여주기 위해서 입니다.
             ex)프라모델을 만들 때 하나의 상자 안에꼭 필요한 부품만 들어있고,
                 필요 없는 부품은 들어있지 않은 것과 같다고 생각하면 된다!
 */
class Tv1_2Main {
...
1번째 Tv인스턴스의 브랜드 명: null
2번째 Tv인스턴스의 브랜드 명: null
3번째 Tv인스턴스의 브랜드 명: null

1번째 Tv인스턴스의 브랜드 명: samsung
2번째 Tv인스턴스의 브랜드 명: lg
3번째 Tv인스턴스의 브랜드 명: apple
 */