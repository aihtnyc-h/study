...
생성자 에서 다른 생성자를 호출할 때 사용합니다.this() 를 사용하지 않고 클래스명(); 이렇게 생성자를 호출하려고 하면 Error 가 발생합니다.다른 생성자 호출시 첫 줄에서 만 사용 가능합니다.

아래 예제코드로 학습해 보겠습니다. (`Tv(String color, long price)` 변경 내용 확인!)
 */
public class Tv10_2 {
    // 속성 : 변수 선언
    boolean power; // 전원상태
